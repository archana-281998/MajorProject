...
namespace Application12.Web.Areas.Products.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderNumber,OrderProductName,OrderDateTime,Amount,ProductId")] Order order)
        {
        ...
        // POST: Products/Orders/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderNumber,OrderProductName,OrderDateTime,Amount,ProductId")] Order order)
        {
